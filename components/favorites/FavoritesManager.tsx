              ...
              return (
                ...
                >
                  ...
                  <button
                    ...
                    className="absolute top-2.5 right-2.5 h-6 w-6 flex items-center justify-center text-on-surface-variant hover:text-primary rounded-full hover:bg-white/5 transition-colors cursor-pointer z-10"
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="relative w-full max-w-md">
            <input
              ...
              className="w-full h-11 pl-10 pr-10 bg-[#2C2C2E]/65 border border-outline/30 rounded-full text-[14px] text-on-surface placeholder-on-surface-variant focus:outline-none focus:border-primary/50 transition-colors"
            />
            {/* Search Icon */}
            ...
            {filteredDrivers.map((driver) => {
              ...
              return (
                <GlassCard
                  ...
                  style={{
                    borderColor: isFav ? teamColor : "rgba(255, 255, 255, 0.12)",
                  ...
                  <button
                    ...
                    className={`h-9 w-9 flex items-center justify-center rounded-full border cursor-pointer transition-colors shrink-0 z-10 ${
                      isFav
                        ...
                        : "bg-[#2C2C2E]/40 border-outline/35 text-on-surface-variant hover:text-on-surface hover:border-outline/50"
                    }`}
